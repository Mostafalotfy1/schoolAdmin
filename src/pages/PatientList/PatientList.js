...
import ApplicationList from '../DoctorList/DoctorList'
...
export default function PatientList({ isOpenSidebar, onCloseSidebar }) {
    ...
    console.log(parents.uid)
    const dataP = parents.map(Parent => { 
                ...
                <div className="row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <div className="firstContainer">
                            <TittleLoginAndSignUpCards tittleValue="اولياء الامور" />
                        </div>
                        <div className="newBtn">
                        </div>
                        <Card className="firstContainer2 mb-5" style={{direction:'rtl'}} >
